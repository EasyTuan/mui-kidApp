...
(function($, window, document) {
	...
	var IndexedList = $.IndexedList = $.Class.extend({
		...
		findElements: function() {
			...
			self.el.bar = document.querySelector(classSelector('indexed-list-bar'));
			self.el.barItems = [].slice.call(document.querySelectorAll(classSelector('indexed-list-bar') + ' a'));
			...
			self.el.alert = document.querySelector(classSelector('indexed-list-alert'));
		},
		caleLayout: function() {
			var self = this;
