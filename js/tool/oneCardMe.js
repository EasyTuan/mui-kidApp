...
mui.plusReady(function(){
	...
	mui("#cardList").on("tap","li",function(){
		//1为收藏;0为我的
		type==1?openNew("cardDetails.html",{CardGroupId:this.dataset.id}):openNew("cardDetails.html",{CardGroupId:this.dataset.id,BrandId:BrandId});
	})
	...
	if(type==0){
		request("/Card/getCardGroupListByPlayerId",{
			...
			if(r.code==-1){
				...
				mui.toast(r.msg);
				render("#cardList","cardListTep1",{data:[]});
